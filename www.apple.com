...
<head>
	...
	<link rel="stylesheet" href="http://images.apple.com/ac/globalheader/1.0/styles/globalheader.css" type="text/css" />
...
<meta property="analytics-s-bucket-2" content="apple{COUNTRY_CODE}global" />
	...
	<meta property="og:image" content="http://images.apple.com/home/images/og.jpg?201409261557" />
	...
	<link rel="stylesheet" href="http://images.apple.com/v/home/bf/styles/home.built.css" type="text/css" />
	<link rel="stylesheet" href="http://images.apple.com/home/styles/home.css" type="text/css" />
	<link rel="stylesheet" href="http://images.apple.com/home/styles/promos.css" type="text/css" />
	<script src="http://images.apple.com/v/home/bf/scripts/head.built.js" type="text/javascript" charset="utf-8"></script>
</head>
...
<script src="http://images.apple.com/ac/globalheader/1.0/scripts/globalheader.js" type="text/javascript" charset="utf-8"></script>
	...
	<section class="hero iphone6">
		<a href="/iphone-6/" class="hero-click-target block" data-analytics-click="prop3:iphone 6,prefix:h"></a>
		<div class="hero-content">
			<div class="copy">
				<h1 class="replaced">iPhone 6</h1>
				<h2>Bigger than bigger</h2>
				<ul class="links">
					<li data-analytics-region="learn more"><a class="icon icon-more" href="/iphone-6/" data-analytics-click="prop3:iphone 6 - learn more">Learn more</a></li>
					<li><a class="icon icon-play" href="/iphone-6/films/#video-product">Watch the film</a></li>
					<li><a class="icon icon-play" href="/live/2014-sept-event/">Experience the keynote</a></li>
				</ul>
			</div>
	...
	<section class="hero apple-watch">
		<a href="/watch/" class="hero-click-target block hero-image" data-analytics-click="prop3:applewatch,prefix:h"></a>
		<div class="hero-content">
			<div class="copy">
				<h1 class="replaced">Apple Watch</h1>
				<ul class="links">
					<li data-analytics-region="learn more"><a class="icon icon-more" href="/watch/" data-analytics-click="prop3:applewatch - learn more">Learn more</a></li>
					<li><a class="icon icon-play" href="/watch/films/#film-design">Watch the film</a></li>
					<li><a class="icon icon-play" href="/live/2014-sept-event/">Experience the keynote</a></li>
				</ul>
			</div>
		</div>
	...
	<aside class="promos" id="promos" data-promo-key="homepage-201409261557" data-promo-classes="promo1,promo2,promo3,promo4,hero" data-analytics-region="promos">
	<ul>
		
		<li>
			<a class="promo promo1 promo-watch" href="/watch/">
	Apple Watch
	Our most personal device yet.
</a>

			<a class="promo promo1 promo-iphone6" href="/iphone-6/">
	iPhone 6
	Bigger than bigger
</a>
		...
		<li>
			<a class="promo promo2 promo-ios8" href="/ios/">
	iOS 8
	Now Available.
</a>
		...
		<li>
			<a class="promo promo3 promo-u2" href="/U2/">
	The new album from U2 is here.
	And it's already in your iTunes music library.
</a>

		</li>
		
		<li>
			<a class="promo promo4 promo-privacy" href="/privacy/">
...
<div class="gf-sosumi footer-sosumi">
	...
	<script src="http://images.apple.com/v/home/bf/scripts/home.built.js" type="text/javascript" charset="utf-8"></script>
</body>
</html>
